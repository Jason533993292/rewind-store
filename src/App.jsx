      ...
      <div onMouseEnter={() => setDockHover(true)} onMouseLeave={() => setDockHover(false)}
        ...
        {dockHover && (<button onClick={() => setShowReferral(true)}
          ...
          style={{
            ...
            transition: 'opacity 0.3s cubic-bezier(0.32, 0.72, 0, 1) 0.12s, transform 0.2s cubic-bezier(0.34, 1.56, 0.64, 1), color 0.15s ease',
        ...
        {dockHover && (<button
          ...
          fontSize: '13px', fontWeight: 600,
          opacity: dockHover ? 0.35 : 0,
          transition: 'opacity 0.3s cubic-bezier(0.32, 0.72, 0, 1) 0.12s, transform 0.2s cubic-bezier(0.34, 1.56, 0.64, 1)',
          pointerEvents: dockHover ? 'auto' : 'none', minWidth: 0, flexShrink: 1,
        }}>
