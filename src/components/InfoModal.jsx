...
const PAGES = {
  privacy: {
    ...
    sections: [
      ...
      { heading: 'Third-Party Services', text: 'Stripe (US): Payment processing — view their privacy policy at stripe.com/privacy. Supabase (US): Cloud database hosting. Resend (US): Order confirmation emails. Google Gemini (US): AI-powered chat auto-replies. These services may process your data outside the EU/EEA under Standard Contractual Clauses.' },
      { heading: 'Your Rights (GDPR)', text: 'Under GDPR you have the right to access, rectify, restrict, port, or delete your personal data, and to object to processing. You can withdraw marketing consent at any time. You also have the right to lodge a complaint with the Belgian Data Protection Authority (dataprotectionauthority.be). To exercise any of these rights, email orders@rewind-stores.com.' },
    ]
  },
  shipping: {
    title: 'Shipping',
