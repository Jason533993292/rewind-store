...
export default function LegalPage({ page, onClose }) {
  ...
  const pages = {
    privacy: {
      ...
      sections: [
        { heading: 'Who We Are', text: 'REWIND is a vintage streetwear store run as a sole trader, based at Romeinsesteenweg, 1800 Vilvoorde, Belgium. For questions about your data, contact us at orders@rewind-stores.com.' },
